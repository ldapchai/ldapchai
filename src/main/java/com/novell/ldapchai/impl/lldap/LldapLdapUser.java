...
import com.novell.ldapchai.impl.openldap.entry.OpenLDAPModifyPasswordRequest;
...
public class LldapLdapUser extends AbstractChaiUser implements ChaiUser
{

    public LldapLdapUser( final String userDN, final ChaiProvider chaiProvider )
    {
