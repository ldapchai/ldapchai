...
public final class PutLoginConfigRequest implements ExtendedRequest
{
    private static final String OID = "2.16.840.1.113719.1.39.42.100.1";
    ...
    public PutLoginConfigRequest( final String var1, final String var2, final int var3, final int[] var4, final String var5, final int var6, final byte[] var7 )
    {
        this.treeName = var1;
        this.objectDN = var2;
    ...
    {
        return new PutLoginConfigResponse( var1, var2, var3, var4 );
    }
    ...
    public byte[] getEncodedValue()
    {
        ...
        {
            throw new IllegalStateException( "Error BER Encoding PutLoginConfigRequest data: " + var2.toString() );
        }
