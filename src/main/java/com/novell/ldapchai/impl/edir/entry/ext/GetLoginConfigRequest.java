...
public final class GetLoginConfigRequest implements ExtendedRequest
{
    private static final String OID = "2.16.840.1.113719.1.39.42.100.3";
    ...
    public GetLoginConfigRequest( final String var1, final String var2, final int var3, final int[] var4, final String var5 )
    {
        this.treeName = var1;
        this.objectDN = var2;
    ...
    {
        return new GetLoginConfigResponse( var1, var2, var3, var4 );
    }
    ...
    public byte[] getEncodedValue()
    {
        try
        {
            this.encodedValue = NMASLdapExtBerEncoder.encodeGetLoginData( this.treeName, this.objectDN, this.methodIDLen, this.methodID, this.tag );
        }
        catch ( final IOException var2 )
        {
            throw new IllegalStateException( "Error BER Encoding GetLoginConfigRequest data: " + var2.toString() );
        }
