...
public final class PutLoginSecretResponse implements ExtendedResponse
{
    private static final String OID = "2.16.840.1.113719.1.39.42.100.8";
    private final byte[] responseBer;
    private BerDecoder ber;
    private final int nmasVersion;
    private final int nmasRetCode;

    PutLoginSecretResponse( final String var1, final byte[] var2, final int var3, final int var4 )
