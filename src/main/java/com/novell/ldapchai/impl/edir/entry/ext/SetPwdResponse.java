...
public final class SetPwdResponse implements ExtendedResponse
{
    private static final String OID = "2.16.840.1.113719.1.39.42.100.12";
    ...
    SetPwdResponse( final String var1, final byte[] var2, final int var3, final int var4 )
            throws NamingException
    {
        this.responseBer = var2;
        final NMASLdapExtBerDecoder var5 = new NMASLdapExtBerDecoder( var2, var3, var4 );
        var5.decodeSetPwdData();
